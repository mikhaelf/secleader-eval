...
**Output & scoring:** Follow [output-template.md](output-template.md) exactly. Apply rules in [scoring.md](scoring.md) (internal — do not print the scoring guide).
