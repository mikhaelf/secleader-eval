...
**Example:** `/secleader-eval Acme Corp`
...
![Mode A: evaluate a company by name](docs/images/03-mode-a-company-name.jpg)
...
![Mode B: evaluate a specific job posting by URL](docs/images/04-mode-b-job-url.jpg)
